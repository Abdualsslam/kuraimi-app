...
// /// بطاقة رصيد حديثة مستوحاة من التصميم المرفق.
// /// - brandColor: لون الهوية الأساسي (بنفسجي مثلاً)
// /// - patternAsset: ملف SVG اختياري لدمج نقش الهوية على البطاقة
// class ModernBalanceCard extends StatelessWidget {
//   final String amountText; // مثال: "$ 1,234"
//   final String bankLabel; // مثال: "Mabank"
//   final Color brandColor; // لون الهوية (بنفسجي/برتقالي...)
...
//     final light = _tint(brandColor, .18); // أفتح شوية
//     final dark = _shade(brandColor, .14); // أغمق شوية
...
//             // نقش هوية SVG (اختياري)
//             if (Assets.iconArt != null)
//               Positioned.fill(
//                 child: IgnorePointer(
//                   child: Opacity(
//                     opacity: 0.10, // خفيف حتى لا يزعج القراءة
...
//                                 child: Text(
//                                   obscureAmount ? '••••' : amountText,
//                                   key: ValueKey(obscureAmount),
//                                   maxLines: 1,
...
//                                 tooltip: obscureAmount ? 'Show' : 'Hide',
...
//                   // اليمين: Card + اسم البنك
//                   Column(
//                     crossAxisAlignment: CrossAxisAlignment.end,
//                     children: [
//                       Text('Card', style: textTheme.labelLarge?.copyWith(color: Colors.white70, letterSpacing: .2)),
//                       const SizedBox(height: 6),
//                       Text(
//                         bankLabel,
//                         style: textTheme.titleLarge?.copyWith(color: Colors.white, fontWeight: FontWeight.w700, letterSpacing: .2),
//                       ),
//                     ],
//                   ),
//                 ],
...
// /// يرسم أقواس/دوائر زخرفية شفافة (مثل اللقطات)
...
//     // دائرة علوية يسار خفيفة (مثل البُقعة)
//     // final spot = Paint()
//     //   ..style = PaintingStyle.fill
//     //   ..color = color.withOpacity(.70);
//     // canvas.drawCircle(Offset(size.width * .20, size.height * .18), 16, spot);
//   }
